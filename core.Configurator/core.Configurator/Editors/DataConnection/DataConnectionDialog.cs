...
namespace mop.Configurator.Editors.DataConnection
{
	public partial class DataConnectionDialog : Form
	{
		public DataConnectionDialog()
		{
            ...
            DataConnectionDialogConfiguration.Default.ApplyConfiguration(this);

           DataSources.Add(DataSource.SqlDataSource);
           DataSources.Add(DataSource.SqlFileDataSource);
           DataSources.Add(DataSource.OracleDataSource);
           DataSources.Add(DataSource.AccessDataSource);
           DataSources.Add(DataSource.OdbcDataSource);

           UnspecifiedDataSource.Providers.Add(DataProvider.SqlDataProvider);
           UnspecifiedDataSource.Providers.Add(DataProvider.OracleDataProvider);
           UnspecifiedDataSource.Providers.Add(DataProvider.OleDBDataProvider);
           UnspecifiedDataSource.Providers.Add(DataProvider.OdbcDataProvider);
           DataSources.Add(UnspecifiedDataSource);
        }
